...
class ContextManager:
    ...
    def build_prompt(self, user_query: str) -> str:
        ...
        prompt = (
            ...
            "1. If you generate code for a new file, PLEASE provide the shell command to create it (e.g., using `cat << 'EOF' > filename.py`).\n"
            "2. If modifying an existing file, provide the diff or the full file content with clear instructions.\n"
            "3. Answer in the requested language (Korean implied if query is Korean).\n\n"
            "--- Project Files ---\n"
            f"{context_str}\n\n"
            "--- End of Context ---\n\n"
